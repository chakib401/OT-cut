# Code based on https://github.com/ChongYou/subspace-clustering/blob/master/cluster/selfrepresentation.py
...
def active_support_elastic_net(X, y, alpha, tau=1.0, algorithm='lasso_lars', support_init='knn',
    ...
    algorithm : string, default ``lasso_lars``
        Algorithm for computing solving the subproblems. Either lasso_lars or lasso_cd
